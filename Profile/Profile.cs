...
{		
	...
	public abstract class Profile : IProfile
	{
		...
		/// <exception cref="InvalidOperationException">Setting this property if ReadOnly is true. </exception>
		/// <remarks>
		...
		/// <exception cref="InvalidOperationException">Setting this property if it's already true. </exception>
		/// <remarks>
		...
		/// <exception cref="ArgumentNullException">ds is null. </exception>
		/// <remarks>
		...
		/// <summary>
		///   Gets the name for the program that loaded this assembly. </summary>
		/// <remarks>
		///   This property is used by file-based Profile implementations 
		///   that need the name of the executable program when returning 
		///   the DefaultName. It is guaranteed to return a value, even if the
		///   name of the program cannot be determined for whatever reason.  </remarks>
		/// <seealso cref="DefaultName" />
		protected string ProgramExe
		{
			get
			{
				try
		...
		/// <exception cref="InvalidOperationException">name is empty or null. </exception>
		/// <seealso cref="Name" />
		...
		/// <exception cref="InvalidOperationException">ReadOnly is true. </exception>
		/// <seealso cref="ReadOnly" />
		...
		/// <exception cref="Exception">The test failed. </exception>
